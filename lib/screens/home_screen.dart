...
class _HomeScreenState extends State<HomeScreen> {
 List <Workorder> _workorder=[];
  ...
  void initState(){
    super.initState();
    getWorkOrders().then((value) => setState((){_workorder=value;}) );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:FloatingActionButton(
        ...
        elevation: 25,
        onPressed: () { Navigator.pushNamed(context, "CalenderScreen"); },
        //params
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
                ...
                child: RichText(
                  text: TextSpan(
                    ...
                    style: const TextStyle(
                      ...
                      color: Colors.white,shadows: [Shadow(offset: Offset(10,10),blurRadius: 25,color: Colors.black)]
                    ),
                    children: [
                      const TextSpan(
                      ...
                      TextSpan(
                          ...
                          style:const TextStyle(
                              color: Colors.white,
                              fontSize: 15,
                              fontWeight: FontWeight.normal,shadows: [Shadow(offset: Offset(10,10),blurRadius: 25,color: Colors.black)]
                          )
                      )]
                  ),
                ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 20,),
                    Text("Here is a list of schedule you need to check ...",style: TextStyle(
                        fontSize: 20,
                        color: Colors.white,
                        letterSpacing: 1,
                        shadows: [Shadow(offset: Offset(10,10),blurRadius: 25,color: Colors.black)]
          ...
          ListView.builder(
              scrollDirection: Axis.vertical,
              itemCount:_workorder==null? 0: _workorder.length ,
  ...
  static Future<List<Workorder>> getWorkOrders() async{
      ...
      try{
        var response=await http.get(Uri.parse("https://ap-acc.maximo.nl/maximo/api/os/MXAPIWODETAIL?lean=1&mxlaction=query&oslc.select=wonum,siteid,description,longdescription.ldtext,status&oslc.pageSize=100&oslc.where=owner=%22OMAR.HUDIFA%22"),
            headers: ({"apikey":"a44eb9m9fuccou1n9skgi8rstt7lf49vj55mh1u1"})

        );
        String jsonData=json.decode(response.body);
        final List <Workorder> workorders=workorderFromJson(jsonData) as List<Workorder>;

...
class _LoginScreenState extends State<LoginScreen> {
            ...
            child: Column(
              children: [
                ...
                InputField(
                  height: height,
                  width: width,
                  fieldeController: usernameController,
                ...
                InputField(
                  height: height,
                  width: width,
                  fieldeController: passwordController,
                ...
                InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text("Log In",
                          style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, letterSpacing: 0.8, color: Theme.of(context).primaryColor)),
                    )),
              ],
            ),
          )
  ...
  Future<void> login() async {
    if (usernameController.text.isNotEmpty && passwordController.text.isNotEmpty) {
      ...
      sl<AppSharedPrefs>().setApiKey(jsonData["member"][0]["apikey"]);
      sl<AppSharedPrefs>().setUserId(jsonData["member"][0]["userid"]);
      /* List member=[];
